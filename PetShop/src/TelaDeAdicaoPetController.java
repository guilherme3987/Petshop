...
public class TelaDeAdicaoPetController {
    ...
    void AdicionarNovoPet(ActionEvent event) {
        ...
        if (validarCampos()) {
            ...
            exibirAlerta("Adicionando Novo Pet", "Novo Pet adicionado com sucesso!", Alert.AlertType.INFORMATION);

            // Limpa os campos após a adição
            limparCampos();
        } else {
            exibirAlerta("Campos Incompletos", "Preencha todos os campos para adicionar um novo Pet.", Alert.AlertType.WARNING);
        }
    }
